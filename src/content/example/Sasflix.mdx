...
<div class="grid grid-cols-2 sm:grid-cols-1 gap-4 text-center">
	<div>
		**Nuxt app**
		<GithubLink href="https://github.com/flexscss/sasflix" class="w-full" />
	</div>
	<div>
		**Vue app inside Astro**
		<GithubLink href="https://github.com/flexscss/unknwn.tech-astro/tree/main/src/components/vue/examples/sasflix" class="w-full" />
	</div>
</div>
